    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" class="no-js no-jr">
      <head>
        <script type="text/javascript" src="<?php print $pubreader_path; ?>/js/jr.boots.js"> </script>
        <title>
          <?php print $title; ?>
        </title>
        <meta charset="utf-8"/>
        ...
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/lib/css/normalize.css" type="text/css" />
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/lib/css/figpopup.css" type="text/css" />
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/css/jr.ui.css" type="text/css" />
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/css/jr.pagemanager.css" type="text/css" />
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/css/jr.pageturnsensor.css" type="text/css" />
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/css/jr.pageprogressbar.css" type="text/css" />
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/css/jr.objectbox.css" type="text/css" />
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/css/jr.panel.css" type="text/css" />
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/css/jr.panel.typo.css" type="text/css" />
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/css/jr.panel.cmap.css" type="text/css" />
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/css/jr.panel.istrip.css" type="text/css" />
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/css/jr.fip.css" type="text/css" />
        <link rel="stylesheet" href="<?php print $pubreader_path; ?>/css/jr.content.css" type="text/css" />
      </head>

      <body>
        <div id="jr" data-jr-path="<?php print $pubreader_path; ?>/">
          ...
          <div id="jr-scripts">
            <script src="<?php print $pubreader_path; ?>/lib/js/jquery-1.7.2.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/lib/js/modernizr.jr.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/lib/js/jquery.throttle.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/lib/js/jquery.mousewheel.js?x=1" type="text/javascript"></script>
            <script src="<?php print $pubreader_path; ?>/lib/js/rangeinput.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/lib/js/jquery.touchSwipe.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/lib/js/jquery.hoverIntent.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/lib/js/figpopup.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jr.utils.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.ft.js" type="text/javascript"></script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.pagemanager.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.paginationstatus.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.pageturnsensor.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.pageprogressbar.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.links.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.historykeeper.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.objectbox.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.switcher.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.panel.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.panel.typo.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.panel.cmap.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.panel.istrip.js" type="text/javascript"> </script>
            <script src="<?php print $pubreader_path; ?>/js/jquery.jr.fip.js" type="text/javascript"></script>
            <script src="<?php print $pubreader_path; ?>/js/jats.reader.js" type="text/javascript"> </script>
